...
Both installers build Kiwi from source (requires the [.NET 10 SDK](https://dotnet.microsoft.com/download/dotnet/10.0)) and add `kiwi` to your PATH. Open a new terminal and you're ready:
```bash
kiwi --help
```
