...
public static class CoreBuiltin
{
    ...
    public const string NamedCaptures   = "named_captures";
    public const string ScanGroups      = "scan_groups";
    public const string RegexEscape     = "regex_escape";
    ...
    private static readonly FrozenDictionary<string, TokenName> _map
        = new Dictionary<string, TokenName>
        {
            ...
            { NamedCaptures,   TokenName.Builtin_Core_NamedCaptures  },
            { RegexEscape,     TokenName.Builtin_Core_RegexEscape    },
            { ScanGroups,      TokenName.Builtin_Core_ScanGroups     },
