...
public struct BooleanOp
{
    public static bool IsTruthy(Value value)
    {
        return value.Type switch
        {
            ...
            Typing.ValueType.Bytes => value.GetBytes().Length > 0,
    ...
    public static bool IsSame(Value v1, Value v2)
    {
        ...
        return v1.Type switch
        {
            ...
            Typing.ValueType.Hashmap => v2.IsHashmap() && Value.CompareHashmaps(v1.GetHashmap(), v2.GetHashmap()) == 0,
            Typing.ValueType.List => v2.IsList() && Value.CompareLists(v1.GetList(), v2.GetList()) == 0,
            Typing.ValueType.Bytes => v2.IsBytes() && Value.CompareBytes(v1.GetBytes(), v2.GetBytes()) == 0,
            Typing.ValueType.Object => v2.IsObject() && Value.CompareObjects(v1.GetObject(), v2.GetObject()) == 0,
