...
std::vector<std::string> interp_params(std::string s);
std::vector<std::string> interp_range(std::string s);
std::vector<std::string> interp_bracketrange(std::string s);
...
std::string &replace(std::string &original, std::string target,
...
std::string ltrim_ws(const std::string &str) {
    auto it =
        find_if_not(str.begin(), str.end(), [](int c) { return isspace(c); });
